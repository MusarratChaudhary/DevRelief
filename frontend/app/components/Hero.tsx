...
//   // ✅ useEffect must be outside any function
//   useEffect(() => {
...
//       const data = await res.json();
//       console.log("Fix Response:", data); // Response check karo
...
//   return (
//     <main className="flex min-h-screen items-center justify-center bg-gradient-to-b from-gray-600 via-gray-200 to-gray-100 p-4">
...
//           Paste your Java runtime exception and optional code snippet to get an
//           instant AI-generated fix.
//         </p>
...
//             onClick={handleFix}
//             disabled={loading}
//             className="w-full sm:w-auto px-6 py-3 rounded-md bg-gray-300 text-blue-950 font-semibold 
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-linear-to-b  from-gray-600 via-gray-200 to-gray-100 p-4">
      <section className="w-full max-w-3xl bg-gray-100 rounded-xl shadow-xl p-6 sm:p-10">
        ...
        <p className="text-center text-gray-700 mb-8">
          Paste your Java error and optional code snippet to get an
          instant AI-generated fix.
        </p>
